    ...
    <div className="app-frame memory-page">
      <header className="topbar">
        ...
        <div className="header-actions">
          ...
          <Link className="outline-button header-link" href="/">暗算へ戻る</Link>
        </div>
      </header>
      ...
      <main className="memory-main">
        ...
        {currentCard ? (
          ...
          <section className="memory-empty">
            <span>EMPTY DECK</span><h2>出題できるカードがありません。</h2><p>暗算ページの「カードを編集」で、出題するカードをONにしてください。</p><Link href="/">暗算ページへ戻る</Link>
          </section>
        )}
