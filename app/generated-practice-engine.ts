...
export const GENERATED_PRACTICE_SOURCE_REFERENCES = {
  ...
  "material-simple-beam-udl": ["mm-f-resultant", "mm-f-equilibrium", "mm-f-simple-udl", "mm-f-beam-diff", "mm-f-bending-stress", "mm-f-rectangle-bending"],
...
const MATERIAL_GENERATED_VISUALS: Record<MaterialMechanicsGeneratorTemplateId, MaterialMechanicsDiagramKind> = {
  ...
  "material-simple-beam-udl": "additional-simple-udl-rect",
