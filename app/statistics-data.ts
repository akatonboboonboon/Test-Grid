...
export const STATISTICS_FORMULAS: StatisticsFormulaCard[] = [
  ...
  },
  {
    ...
    formula: "P(Hi|A) = P(A|Hi)P(Hi) / P(A)",
...
export const STATISTICS_QUESTIONS: StatisticsQuestion[] = [
  question({ id: "stats-q-mean", topic: "descriptive", genre: "平均", difficulty: 1, format: "number", prompt: "データ 4, 6, 8, 10, 12 の平均を求めよ。", answer: "8", numericAnswer: 8, steps: ["合計は 40", "40÷5 = 8"], explanation: "平均はデータの合計を個数で割る。", formula: "x̄=(Σxi)/n" }),
  question({ id: "stats-q-variance", topic: "descriptive", genre: "母分散", difficulty: 2, format: "number", prompt: "データ 2, 4, 6 の母分散を求めよ。小数第3位まで可。", answer: "8/3 ≒ 2.667", numericAnswer: 8 / 3, tolerance: 0.001, steps: ["平均は4", "偏差平方は4,0,4", "(4+0+4)÷3 = 8/3"], explanation: "母分散なので偏差平方和を n=3 で割る。", formula: "σ²=Σ(xi−x̄)²/n" }),
  question({ id: "stats-q-sd", topic: "descriptive", genre: "標準偏差", difficulty: 1, format: "number", prompt: "母分散が 9 のとき、標準偏差を求めよ。", answer: "3", numericAnswer: 3, steps: ["√9 = 3"], explanation: "標準偏差は分散の正の平方根。", formula: "σ=√V(X)" }),
  ...
  question({ id: "stats-q-linear-var", topic: "descriptive", genre: "一次変換", difficulty: 2, format: "number", prompt: "V(X)=4、Y=2X−1 のとき V(Y) を求めよ。", answer: "16", numericAnswer: 16, steps: ["V(Y)=2²V(X)", "4×4=16"], explanation: "分散には倍率の二乗が効き、定数−1は影響しない。", formula: "V(aX+b)=a²V(X)" }),
  ...
  question({ id: "stats-q-covariance", topic: "relation", genre: "共分散", difficulty: 2, format: "number", prompt: "X=(1,2,3)、Y=(2,4,6) の母共分散を求めよ。小数第3位まで可。", answer: "4/3 ≒ 1.333", numericAnswer: 4 / 3, tolerance: 0.001, steps: ["x̄=2、ȳ=4", "偏差積は2,0,2", "(2+0+2)÷3=4/3"], explanation: "両方が同じ向きに動くため共分散は正になる。", formula: "σxy=Σ(xi−x̄)(yi−ȳ)/n" }),
  ...
  question({ id: "stats-q-regression-slope", topic: "relation", genre: "回帰直線", difficulty: 2, format: "number", prompt: "点 (1,3), (2,5), (3,7) を通る回帰直線の傾き b を求めよ。", answer: "2", numericAnswer: 2, steps: ["xが1増えるとyは2増える", "よって傾きは2"], explanation: "3点は y=2x+1 上に完全に並ぶ。", formula: "b=σxy/σx²" }),
  question({ id: "stats-q-regression-intercept", topic: "relation", genre: "回帰直線", difficulty: 2, format: "number", prompt: "回帰直線の傾き b=2、x̄=3、ȳ=8 のとき切片 a を求めよ。", answer: "2", numericAnswer: 2, steps: ["a=ȳ−bx̄", "8−2×3=2"], explanation: "回帰直線は (x̄,ȳ) を通る。", formula: "a=ȳ−bx̄" }),
  question({ id: "stats-q-r2", topic: "relation", genre: "決定係数", difficulty: 1, format: "number", prompt: "相関係数 r=−0.8 のとき決定係数 R² を求めよ。", answer: "0.64", numericAnswer: 0.64, steps: ["R²=r²", "(−0.8)²=0.64"], explanation: "二乗するので相関係数の符号は消える。", formula: "R²=r²" }),
  ...
  question({ id: "stats-q-permutation", topic: "counting", genre: "順列", difficulty: 1, format: "number", prompt: "7個から3個を選んで順に並べる方法は何通りか。", answer: "210通り", numericAnswer: 210, steps: ["7P3=7×6×5", "=210"], explanation: "順番を区別するので組合せではなく順列。", formula: "nPr=n!/(n−r)!" }),
  question({ id: "stats-q-combination", topic: "counting", genre: "組合せ", difficulty: 1, format: "number", prompt: "8人から2人を選ぶ方法は何通りか。", answer: "28通り", numericAnswer: 28, steps: ["8C2=(8×7)/(2×1)", "=28"], explanation: "選ばれた2人の順番は区別しない。", formula: "nCr=n!/{r!(n−r)!}" }),
  ...
  question({ id: "stats-q-at-least-head", topic: "counting", genre: "余事象", difficulty: 2, format: "number", prompt: "公平なコインを3回投げ、少なくとも1回表が出る確率を求めよ。", answer: "7/8 = 0.875", numericAnswer: 7 / 8, steps: ["1回も表が出ない確率は(1/2)³=1/8", "1−1/8=7/8"], explanation: "『少なくとも』は余事象を使うと一度で求められる。", formula: "1−P(0回)" }),
  question({ id: "stats-q-addition", topic: "counting", genre: "加法定理", difficulty: 2, format: "number", prompt: "P(A)=0.4、P(B)=0.5、P(A∩B)=0.2 のとき P(A∪B) を求めよ。", answer: "0.7", numericAnswer: 0.7, steps: ["0.4+0.5−0.2", "=0.7"], explanation: "共通部分を二重に数えた分だけ引く。", formula: "P(A∪B)=P(A)+P(B)−P(A∩B)" }),
  ...
  question({ id: "stats-q-conditional", topic: "conditional", genre: "条件付き確率", difficulty: 1, format: "number", prompt: "P(A∩B)=0.12、P(B)=0.30 のとき P(A|B) を求めよ。", answer: "0.4", numericAnswer: 0.4, steps: ["0.12÷0.30", "=0.4"], explanation: "条件側Bの確率を分母に置く。", formula: "P(A|B)=P(A∩B)/P(B)" }),
  question({ id: "stats-q-product", topic: "conditional", genre: "乗法定理", difficulty: 1, format: "number", prompt: "P(A|B)=0.6、P(B)=0.5 のとき P(A∩B) を求めよ。", answer: "0.3", numericAnswer: 0.3, steps: ["0.6×0.5", "=0.3"], explanation: "条件付き確率と条件側の確率を掛ける。", formula: "P(A∩B)=P(A|B)P(B)" }),
  question({ id: "stats-q-independent", topic: "conditional", genre: "独立", difficulty: 1, format: "number", prompt: "AとBが独立で P(A)=0.4、P(B)=0.5 のとき P(A∩B) を求めよ。", answer: "0.2", numericAnswer: 0.2, steps: ["独立なので0.4×0.5", "=0.2"], explanation: "独立なら積事象の確率は各確率の積。", formula: "P(A∩B)=P(A)P(B)" }),
  question({ id: "stats-q-total", topic: "conditional", genre: "全確率", difficulty: 2, format: "number", prompt: "製品の60%を機械A、40%を機械Bが作る。Aの不良率2%、Bの不良率5%のとき、無作為に選んだ製品が不良である確率を求めよ。", answer: "0.032（3.2%）", numericAnswer: 0.032, tolerance: 0.00001, steps: ["A経路:0.6×0.02=0.012", "B経路:0.4×0.05=0.020", "合計0.032"], explanation: "原因ごとの経路確率を足す。", formula: "P(D)=ΣP(D|Hi)P(Hi)" }),
  question({ id: "stats-q-bayes-machine", topic: "conditional", genre: "ベイズ", difficulty: 3, format: "number", prompt: "前問と同じ条件で、不良品が機械A製である確率を求めよ。小数第3位まで可。", context: "機械A:生産60%・不良率2%、機械B:生産40%・不良率5%", answer: "0.375（37.5%）", numericAnswer: 0.375, steps: ["Aかつ不良=0.6×0.02=0.012", "不良全体=0.032", "0.012÷0.032=0.375"], explanation: "分子は目的のA経路、分母は不良になる全経路。", formula: "P(A|D)=P(D|A)P(A)/P(D)" }),
  question({ id: "stats-q-bayes-test", topic: "conditional", genre: "ベイズ", difficulty: 3, format: "number", prompt: "有病率1%、感度95%、偽陽性率5%の検査で陽性だった。実際に病気である確率を求めよ。小数第3位まで可。", answer: "約0.161（16.1%）", numericAnswer: 0.0095 / 0.059, tolerance: 0.001, steps: ["病気かつ陽性=0.01×0.95=0.0095", "健康かつ陽性=0.99×0.05=0.0495", "0.0095÷(0.0095+0.0495)≈0.161"], explanation: "感度が高くても、有病率が低いと偽陽性の人数が無視できない。", formula: "P(病気|陽性)=目的経路/陽性の全経路" }),
  ...
  question({ id: "stats-q-expectation", topic: "random-variable", genre: "期待値", difficulty: 1, format: "number", prompt: "Xが0,1,2を確率0.2,0.5,0.3で取るとき E[X] を求めよ。", answer: "1.1", numericAnswer: 1.1, steps: ["0×0.2+1×0.5+2×0.3", "=1.1"], explanation: "値に確率を掛けた加重平均。", formula: "E[X]=Σxipi" }),
  question({ id: "stats-q-discrete-var", topic: "random-variable", genre: "分散", difficulty: 2, format: "number", prompt: "Xが0,1,2を確率0.2,0.5,0.3で取るとき V(X) を求めよ。", answer: "0.49", numericAnswer: 0.49, steps: ["E[X]=1.1", "E[X²]=0+0.5+4×0.3=1.7", "1.7−1.1²=0.49"], explanation: "E[X²]−E[X]² を使うと表から速く計算できる。", formula: "V(X)=E[X²]−E[X]²" }),
  ...
  question({ id: "stats-q-continuous-mean", topic: "continuous", genre: "期待値", difficulty: 3, format: "number", prompt: "f(x)=x/2 (0≤x≤2) のとき E[X] を求めよ。小数第3位まで可。", answer: "4/3 ≒ 1.333", numericAnswer: 4 / 3, tolerance: 0.001, steps: ["E[X]=∫₀²x·(x/2)dx", "=[x³/6]₀²", "=4/3"], explanation: "連続型では値×密度を積分する。", formula: "E[X]=∫xf(x)dx" }),
  question({ id: "stats-q-continuous-var", topic: "continuous", genre: "分散", difficulty: 3, format: "number", prompt: "f(x)=x/2 (0≤x≤2) のとき V(X) を求めよ。小数第3位まで可。", answer: "2/9 ≒ 0.222", numericAnswer: 2 / 9, tolerance: 0.001, steps: ["E[X]=4/3", "E[X²]=∫₀²x²·(x/2)dx=2", "2−(4/3)²=2/9"], explanation: "E[X²]を積分してからE[X]²を引く。", formula: "V(X)=E[X²]−E[X]²" }),
  ...
  question({ id: "stats-q-z-score", topic: "continuous", genre: "標準化", difficulty: 1, format: "number", prompt: "平均62、標準偏差8の分布で X=74 の z得点を求めよ。", answer: "1.5", numericAnswer: 1.5, steps: ["z=(74−62)/8", "=12/8=1.5"], explanation: "平均より標準偏差1.5個分だけ上にある。", formula: "z=(x−μ)/σ" }),
