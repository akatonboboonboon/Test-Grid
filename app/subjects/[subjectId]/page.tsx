    ...
    <div className="app-frame generic-subject-page" style={pageStyle}>
      <header className="topbar">
        ...
        <div className="header-actions">
          ...
          <Link className="outline-button header-link" href={`/rapid/${subjectId}`}>時間制限 即答練習</Link>
          <Link className="outline-button header-link" href={`/ranking/${subjectId}`}>公式ランキングテスト</Link>
